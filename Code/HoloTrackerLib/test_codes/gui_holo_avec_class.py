...
class MyMainWindow(tk.Tk):
    def __init__(self):
        ...
        foc = ttk.Combobox(tab_conf, textvariable=self.focus)
        foc['values'] = ('SUM_OF_LAPLACIAN', 'SUM_OF_VARIANCE', 'TENENGRAD', 'SUM_OF_INTENSITY')
        foc.bind('<<ComboboxSelected>>', print('test'))
        ...
        foc.grid(row=12, column=1, sticky="w")
